<nav class="site-header sticky-top py-1">
    <div class="container d-flex flex-column flex-md-row justify-content-between">
        ...
        <a class="py-2 d-none d-md-inline-block" href="{{route('login-form')}}">Вход</a>
        <a class="py-2 d-none d-md-inline-block" href="{{route('feedback-form')}}">Обратная связь</a>
        <a class="py-2 d-none d-md-inline-block" href="{{route('feedback-all')}}">Список сообщений</a>
    </div>
</nav>